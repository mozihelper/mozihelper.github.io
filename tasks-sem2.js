...
var TASKS_SEM2 = [
  ...
  },
  {
    ...
    "type": "r1-4",
    "level": 1,
    "title": "Обратный к корню из единицы",
    "statement": "Докажите, что если $\\varepsilon$ — корень степени $n$ из единицы, то $\\varepsilon^{-1}$ тоже корень степени $n$ из единицы, и что $\\varepsilon^{-1}=\\bar\\varepsilon$.",
    "steps": [
      {
        "q": "Первая часть",
        "a": "По условию $\\varepsilon^n=1$, в частности $\\varepsilon\\ne0$ и обратный существует. Возведём обратный в степень $n$: $$(\\varepsilon^{-1})^{n}=(\\varepsilon^{n})^{-1}=1^{-1}=1,$$ значит $\\varepsilon^{-1}$ — корень степени $n$ из единицы."
      },
      {
        "q": "Найти модуль",
        "a": "Из $\\varepsilon^n=1$ следует $|\\varepsilon|^n=1$, а модуль неотрицателен, поэтому $|\\varepsilon|=1$: все корни из единицы лежат на единичной окружности."
      },
      {
        "q": "Вторая часть",
        "a": "Для любого комплексного числа $\\varepsilon\\bar\\varepsilon=|\\varepsilon|^2$. При $|\\varepsilon|=1$ получаем $\\varepsilon\\bar\\varepsilon=1$, то есть $\\bar\\varepsilon=\\varepsilon^{-1}$. $\\blacksquare$"
      },
      {
        "q": "Геометрический смысл",
        "a": "Переход к обратному — это отражение относительно вещественной оси. Множество корней симметрично: вместе с $\\varepsilon$ в нём лежит и сопряжённое число."
      }
    ],
    "answer": "$(\\varepsilon^{-1})^n=1$; поскольку $|\\varepsilon|=1$, обратный совпадает с сопряжённым.",
    "mark": "exam",
    "num": 19
  },
  {
  ...
  },
  {
    ...
    "steps": [
      {
        "q": "Составить систему",
        "a": "Подставим $y=kx+m$ в уравнение эллипса и приведём к общему знаменателю: $$b^2x^2+a^2(kx+m)^2=a^2b^2,$$ то есть $$(b^2+a^2k^2)x^2+2a^2km\\,x+a^2(m^2-b^2)=0.$$"
      },
      {
        "q": "Использовать условие касания",
        "a": "Одна общая точка означает нулевой дискриминант: $$4a^4k^2m^2-4(b^2+a^2k^2)a^2(m^2-b^2)=0.$$ После сокращения на $4a^2$ и раскрытия скобок остаётся $$m^2=b^2+a^2k^2.$$"
      },
      {
        "q": "Выразить точку касания",
        "a": "Единственный корень $x_0=-\\dfrac{a^2km}{b^2+a^2k^2}=-\\dfrac{a^2k}{m}$, а тогда $$y_0=kx_0+m=\\frac{m^2-a^2k^2}{m}=\\frac{b^2}{m}.$$"
      },
      {
        "q": "Выразить коэффициенты обратно",
        "a": "Из последних равенств $m=\\dfrac{b^2}{y_0}$ и $k=-\\dfrac{x_0b^2}{a^2y_0}$."
      },
      {
        "q": "Собрать уравнение",
        "a": "$y=-\\dfrac{x_0b^2}{a^2y_0}x+\\dfrac{b^2}{y_0}$. Умножим на $\\dfrac{y_0}{b^2}$ и перенесём: $$\\frac{x_0x}{a^2}+\\frac{y_0y}{b^2}=1.$$"
      }
    ],
    "answer": "$$\\frac{x_0x}{a^2}+\\frac{y_0y}{b^2}=1.$$ Случай вертикальной касательной ($y_0=0$) разбирается отдельно: там прямая $x=\\pm a$.",
